...
class GroceryPlus extends StatelessWidget {
  const GroceryPlus({Key? key}) : super(key: key);
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: getProportionateScreenHeight(15.5)),
                    buildLocationMethod(context),
                    SizedBox(height: getProportionateScreenHeight(27.0)),
                    buildSearchbar(),
                    SizedBox(height: getProportionateScreenHeight(34.0)),
                    CategoryList(),
                  ],
                ),
              ),
